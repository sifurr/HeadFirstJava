...
public class BeatBoxV2 
{
    ...
    public void buildGUI()
    {
        ...
        // put the components in a grid with rows and colums
    ...
    private void buildTrackAndStart()
    {
        ...
        // get rif of old track and make a fresh one
        sequence.deleteTrack(track);
        track = sequence.createTrack();

        for(int i = 0; i < 16; i++)
        {
            trackList = new int[16]; // build this for each of the 16 rows
    ...
    {
        // hold the state of each check box
        boolean[] checkboxState = new boolean[256];

       // Walk through (ArrayList of the checkboxList),
    ...
    public void readFile()
    {
        ...
        // Now restore the state of eachboxes in the ArrayList 
